...
**Settings Ã¢â€ â€™ Secrets and variables Ã¢â€ â€™ Actions Ã¢â€ â€™ New repository secret**
...
- All tables defined in `services/grn-api/db/migrations/0001_init.sql`
- User onboarding tables from `services/grn-api/db/migrations/0002_user_onboarding.sql`
...
- Ã¢Å“â€¦ Lambda functions now use DATABASE_URL environment variable
- Ã¢Å“â€¦ DynamoDB tables removed from CloudFormation template
- Ã¢Å“â€¦ Database connection string passed as CloudFormation parameter
- Ã¢Å“â€¦ Migrations run automatically during CI/CD deployment
...
```bash
chmod +x services/grn-api/db/migrate.sh
```
