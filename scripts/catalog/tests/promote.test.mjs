  ...
  const step6 = [
    {
      ...
      has_openfarm_support: true, strong_food_evidence: false, edible: true, edible_parts: ['leaf'], match_confidence_band: 'high', guardrail_flags: { conifer: false, industrial: false }, practical_food_score: 2.5,
    },
